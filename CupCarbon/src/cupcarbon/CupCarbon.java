 ...
 * www.cupcarbon.com
 * ----------------------------------------------------------------------------------------------------------------
 * Copyright (C) 2013-2015 Ahcene Bounceur
 * ----------------------------------------------------------------------------------------------------------------
...
//					Layer.getMapViewer().repaint();
	...
	private void initialize() {
		...
		mntmLorient.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "geo.png"));
		...
		mntmBrest.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "geo.png"));
		...
		mntmSansFrancisco.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "geo.png"));
		...
		mntmSantander.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "geo.png"));
		...
		mntmMenuDemo.setIcon(new ImageIcon(CupCarbonParameters.IMGPATH + "demo.png"));
		...
		mntmInitializeAll.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DeviceList.initAllAlgoSelectedNodes();
			}
		});

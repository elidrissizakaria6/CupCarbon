...
public class RandomDeviceParametersWindowsWithoutGrid_WithMarkers extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RandomDeviceParametersWindowsWithoutGrid_WithMarkers frame = new RandomDeviceParametersWindowsWithoutGrid_WithMarkers();
	 ...
	 * Create the frame.
	 */
	public RandomDeviceParametersWindowsWithoutGrid_WithMarkers() {
			...
			public void actionPerformed(ActionEvent e) {
				try{
					n=Integer.parseInt(NBNoeuds.getText());
						...
						RandomDevices.addRandomSensorsWithMarkers(n);

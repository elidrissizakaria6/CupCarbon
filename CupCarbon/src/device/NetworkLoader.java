...
public class NetworkLoader extends Thread {
	...
	public void run() {
		try {
			...
			//while (((s = br.readLine()) != null) && (k++<112)) {}
			//while (((s = br.readLine()) != null) && (k++<161)) {}
			//while (((s = br.readLine()) != null) && (k++<192)) {}
			//while (((s = br.readLine()) != null) && (k++<213)) {}
			//while (((s = br.readLine()) != null) && (k++<250)) {
			//while (((s = br.readLine()) != null) && (k++<270)) {

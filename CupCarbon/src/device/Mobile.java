...
public class Mobile extends MobileG {
	...
	public Mobile(double x, double y, double rayon) {
		super(x, y, rayon,"");
	}
	
	public Mobile(double x, double y, double rayon, String gpsFileName) {
		super(x, y, rayon, gpsFileName);	
	}
	
	public Mobile(String x, String y, String rayon, String gpsFileName) {

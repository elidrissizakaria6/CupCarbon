...
public class Mobile2 extends MobileG {
	
	private static String idFL = "M" ; // ID First Letter

	public Mobile2(double x, double y, double rayon) {
		super(x, y, rayon,"");
	}
	
	public Mobile2(double x, double y, double rayon, String gpsFileName) {
		super(x, y, rayon, gpsFileName);	
	}
	
	public Mobile2(String x, String y, String rayon, String gpsFileName) {
		super(Double.valueOf(x), Double.valueOf(y), Double.valueOf(rayon), gpsFileName);	
	}
